...
mongoose_1.default.connect('mongodb://admin:UKeDe1y45vDN9M05@15.207.8.251:27017/node_dipenit?authSource=admin', { useNewUrlParser: true, useUnifiedTopology: true }, (error) => {
    if (error) {
        console.log(error);
    }
    else {
